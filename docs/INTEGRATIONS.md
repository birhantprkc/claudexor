...
| `CLAUDEXOR_REVIEW_WAVE_ID` | release review | Operator-generated UUID shared by the two native full-context reviewer processes; the sealed release attestation refuses mixed or sequential wave artifacts. |

...
Internal package of [Claudexor](https://github.com/razzant/claudexor) — Managed local daemon: Unix-socket JSON-RPC, token auth, task queue. Runner injected (no second scheduler).

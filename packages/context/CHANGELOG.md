...
- Refuse to persist raw `DIFF.patch` evidence when the candidate diff contains a
  secret-like token; reviewers fail closed before durable raw-secret artifacts are
  written.
- Updated dependencies
